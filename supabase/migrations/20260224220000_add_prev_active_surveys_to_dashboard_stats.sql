-- Add prevActiveSurveys to get_dashboard_stats: count of distinct surveys
-- that had at least one completed response in the previous period.
...
BEGIN
    ...
    -- KPI: Active surveys in previous period (distinct surveys with ≥1 completed response)
    IF v_prev_start IS NOT NULL THEN
