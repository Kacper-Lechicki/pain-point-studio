...
CREATE INDEX IF NOT EXISTS "survey_responses_fingerprint_dedup_idx" ON "public"."survey_responses" USING "btree" ("survey_id", "fingerprint") WHERE ("fingerprint" IS NOT NULL AND "status" = 'completed');
