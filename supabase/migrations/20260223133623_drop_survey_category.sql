-- ============================================================
-- INC-17: Drop surveys.category column
-- ============================================================
-- The category column is fully replaced by project_id +
-- research_phase (added in INC-1, INC-10). This migration:
--   1. Replaces get_user_surveys_with_counts to remove the
--      category reference
--   2. Drops the column
-- ============================================================

-- Step 1: Replace function BEFORE dropping column (function references s.category)
...
ALTER TABLE public.surveys DROP COLUMN category;
