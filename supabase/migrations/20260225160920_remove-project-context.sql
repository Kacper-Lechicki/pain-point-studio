-- =============================================================================
-- Migration: remove_project_context
-- Description: Remove the context/phase split from projects. All projects are
--              now a single unified type. Drops context column from projects,
--              research_phase from surveys, phase from project_insights, and
--              updates RPC functions that referenced those columns.
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. DROP columns and constraints
-- -----------------------------------------------------------------------------

-- projects.context
ALTER TABLE "public"."projects" DROP CONSTRAINT IF EXISTS "projects_context_check";
ALTER TABLE "public"."projects" DROP COLUMN IF EXISTS "context";

-- surveys.research_phase
ALTER TABLE "public"."surveys" DROP CONSTRAINT IF EXISTS "surveys_research_phase_check";
ALTER TABLE "public"."surveys" DROP COLUMN IF EXISTS "research_phase";

-- project_insights.phase
ALTER TABLE "public"."project_insights" DROP CONSTRAINT IF EXISTS "project_insights_phase_check";
ALTER TABLE "public"."project_insights" DROP COLUMN IF EXISTS "phase";

-- -----------------------------------------------------------------------------
-- 2. Update get_user_surveys_with_counts — remove projectContext, researchPhase
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. Update get_project_signals_data — remove researchPhase
-- -----------------------------------------------------------------------------
