  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={onOpen}
        className="border-input bg-muted/50 text-muted-foreground md:hover:bg-muted md:hover:text-foreground hidden h-[30px] w-48 items-center gap-1.5 rounded-md border px-2 text-xs transition-colors md:flex"
