...
function getBarColor(rating: number, scaleMin: number, scaleMax: number): string {
...
function getBarMutedColor(rating: number, scaleMin: number, scaleMax: number): string {
  const range = scaleMax - scaleMin;
